...
* GitHub Issues: <https://github.com/ostrolucky/concise-rectors/issues>
...
* ostrolucky/concise-rectors follows a superset of **[PSR-12 coding standard][psr-12]**.
  Please ensure your code does, too. _Hint: run `composer dev:lint` to check._
* Please **write tests** for any new features you add.
* Please **ensure that tests pass** before submitting your pull request.
  ostrolucky/concise-rectors automatically runs tests for pull requests. However,
...
[github]: https://github.com/ostrolucky/concise-rectors
[issues]: https://github.com/ostrolucky/concise-rectors/issues
[pull requests]: https://github.com/ostrolucky/concise-rectors/pulls
